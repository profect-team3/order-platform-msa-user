...
public class CustomerAddressController {
	...
	public ApiResponse<List<GetCustomerAddressListResponse>> GetCustomerAddresses(@RequestParam Long userId) {
	...
	public ApiResponse<AddCustomerAddressResponse> AddCustomerAddress(
		@RequestBody @Valid AddCustomerAddressRequest request, @RequestParam Long userId) {
